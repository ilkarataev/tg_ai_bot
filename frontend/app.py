...
from libs.db_class import users, photos, render_hosts, video_clips, payments, logs, tg_bot, tg_users, bot_notification
...
admin.add_view(MyView(tg_bot, db.session))
admin.add_view(MyView(tg_users, db.session))
admin.add_view(MyView(bot_notification, db.session))
